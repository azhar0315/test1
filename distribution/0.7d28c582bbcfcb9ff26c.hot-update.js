...
/***/ function(module, exports, __webpack_require__) {
	...
	var PurchaseOrder_service_1 = __webpack_require__(444);
	var router_1 = __webpack_require__(304);
	var PurchaseOrderEditComponent = /** @class */ (function () {
	    function PurchaseOrderEditComponent(router, repository, activatedRoute) {
	        this.router = router;
	    ...
	    PurchaseOrderEditComponent.prototype.math = function (i) {
	    ...
	    PurchaseOrderEditComponent.prototype.findTotal = function () {
	    ...
	    PurchaseOrderEditComponent.prototype.findItem = function (value) {
	        var _this = this;
	        console.log(value);
	        if (value.length > 0) {
	    ...
	    PurchaseOrderEditComponent.prototype.selectinventory = function (name, des, unit, i) {
	    ...
	    PurchaseOrderEditComponent.prototype.showinven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'block';
	    };
	    PurchaseOrderEditComponent.prototype.hideninven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'none';
	    };
	    PurchaseOrderEditComponent.prototype.show = function () {
	        document.getElementById('res').style.display = 'block';
	    };
	    PurchaseOrderEditComponent.prototype.hiden = function () {
	        document.getElementById('res').style.display = 'none';
	    };
	    PurchaseOrderEditComponent.prototype.select = function (name, adress) {
	    ...
	    PurchaseOrderEditComponent.prototype.find = function () {
	        var _this = this;
	    ...
	    PurchaseOrderEditComponent.prototype.add = function (entry) {
	        this.entry.items.push(new PurchaseOrder_interface_1.items());
	    };
	    PurchaseOrderEditComponent.prototype.removeItem = function (i) {
	    ...
	    PurchaseOrderEditComponent.prototype.notify = function () {
	    };
	    PurchaseOrderEditComponent.prototype.update = function (entry) {
	        this.repository.saveEntryv1(entry);
	    };
	    PurchaseOrderEditComponent.prototype.ngAfterViewInit = function () {
	        $.ajax({
	    ...
	    PurchaseOrderEditComponent.prototype.delete = function (entry) {
	        this.repository.deleteEntry(entry);
	    };
	    PurchaseOrderEditComponent = __decorate([
	        core_1.Component({
	            selector: 'NewPurchaseOrderEdit',
	        ...
	        __metadata("design:paramtypes", [router_1.Router, PurchaseOrder_service_1.PurchaseOrderService, router_1.ActivatedRoute])
	    ], PurchaseOrderEditComponent);
	    return PurchaseOrderEditComponent;
	}());
	exports.PurchaseOrderEditComponent = PurchaseOrderEditComponent;
