...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var core_1 = __webpack_require__(3);
	var SalesOrder_interface_1 = __webpack_require__(497);
	var SalesOrder_service_1 = __webpack_require__(498);
	var router_1 = __webpack_require__(304);
	var SalesOrderEditComponent = /** @class */ (function () {
	    function SalesOrderEditComponent(router, repository, activatedRoute) {
	        this.router = router;
	        this.repository = repository;
	        this.activatedRoute = activatedRoute;
	        this.entry = new SalesOrder_interface_1.SalesOrderInterface();
	        this.customer = [];
	        this.inventory = [];
	    }
	    SalesOrderEditComponent.prototype.math = function (i) {
	    ...
	    SalesOrderEditComponent.prototype.findTotal = function () {
	    ...
	    SalesOrderEditComponent.prototype.findItem = function (value) {
	        var _this = this;
	        console.log(value);
	        if (value.length > 0) {
	    ...
	    SalesOrderEditComponent.prototype.selectinventory = function (name, des, unit, i) {
	    ...
	    SalesOrderEditComponent.prototype.showinven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'block';
	    };
	    SalesOrderEditComponent.prototype.hideninven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'none';
	    };
	    SalesOrderEditComponent.prototype.show = function () {
	        document.getElementById('res').style.display = 'block';
	    };
	    SalesOrderEditComponent.prototype.hiden = function () {
	        document.getElementById('res').style.display = 'none';
	    };
	    SalesOrderEditComponent.prototype.select = function (name, adress) {
	        document.getElementById('cus').value = name;
	        document.getElementById('address').value = adress;
	    };
	    SalesOrderEditComponent.prototype.find = function () {
	        var _this = this;
	    ...
	    SalesOrderEditComponent.prototype.add = function (entry) {
	        this.entry.items.push(new SalesOrder_interface_1.items());
	    };
	    SalesOrderEditComponent.prototype.removeItem = function (i) {
	    ...
	    SalesOrderEditComponent.prototype.ngOnInit = function () {
	        var _this = this;
	    ...
	    SalesOrderEditComponent.prototype.ngOnDestroy = function () {
	        this.repository.unregisterObserver(this);
	    };
	    SalesOrderEditComponent.prototype.ngAfterViewInit = function () {
	        $.ajax({
	    ...
	    SalesOrderEditComponent.prototype.notify = function () {
	    };
	    SalesOrderEditComponent.prototype.update = function (entry) {
	        this.repository.saveEntryv1(entry);
	    };
	    SalesOrderEditComponent.prototype.delete = function (entry) {
	        this.repository.deleteEntry(entry);
	    };
	    SalesOrderEditComponent = __decorate([
	        core_1.Component({
	            selector: 'NewSalesOrderEdit',
	        ...
	        __metadata("design:paramtypes", [router_1.Router, SalesOrder_service_1.SalesOrderService, router_1.ActivatedRoute])
	    ], SalesOrderEditComponent);
	    return SalesOrderEditComponent;
	}());
