...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var core_1 = __webpack_require__(3);
	var PurchaseInvoice_interface_1 = __webpack_require__(453);
	var PurchaseInvoice_service_1 = __webpack_require__(454);
	var router_1 = __webpack_require__(304);
	var PurchaseInvoiceEditComponent = /** @class */ (function () {
	    function PurchaseInvoiceEditComponent(router, repository, activatedRoute) {
	        this.router = router;
	        this.repository = repository;
	        this.activatedRoute = activatedRoute;
	        this.entry = new PurchaseInvoice_interface_1.PurchaseInvoiceInterface();
	        this.supplier = [];
	        this.inventory = [];
	    }
	    PurchaseInvoiceEditComponent.prototype.math = function (i) {
	    ...
	    PurchaseInvoiceEditComponent.prototype.findItem = function (value) {
	        var _this = this;
	        console.log(value);
	        if (value.length > 0) {
	    ...
	    PurchaseInvoiceEditComponent.prototype.findTotal = function () {
	    ...
	    PurchaseInvoiceEditComponent.prototype.selectinventory = function (name, des, unit, i) {
	    ...
	    PurchaseInvoiceEditComponent.prototype.showinven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'block';
	    };
	    PurchaseInvoiceEditComponent.prototype.hideninven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'none';
	    };
	    PurchaseInvoiceEditComponent.prototype.show = function () {
	        document.getElementById('res').style.display = 'block';
	    };
	    PurchaseInvoiceEditComponent.prototype.hiden = function () {
	        document.getElementById('res').style.display = 'none';
	    };
	    PurchaseInvoiceEditComponent.prototype.select = function (name, adress) {
	    ...
	    PurchaseInvoiceEditComponent.prototype.find = function () {
	        var _this = this;
	    ...
	    PurchaseInvoiceEditComponent.prototype.add = function (entry) {
	        this.entry.items.push(new PurchaseInvoice_interface_1.items());
	    };
	    PurchaseInvoiceEditComponent.prototype.removeItem = function (i) {
	    ...
	    PurchaseInvoiceEditComponent.prototype.ngOnInit = function () {
	        var _this = this;
	        this.repository.registerObserver(this);
	        this.repository.createv1();
	        this.activatedRoute.params.forEach(function (params) {
	            var id = params['id'];
	            _this.repository.fetchEntry(id)
	                .then(function (entry) { return _this.entry = entry; });
	        });
	        this.repository.fetchSupplier()
	            .then(function (supplier) { return _this.supplier = supplier; })
	            .then(function (supplier) { return console.log(_this.supplier); });
	    ...
	    PurchaseInvoiceEditComponent.prototype.ngOnDestroy = function () {
	        this.repository.unregisterObserver(this);
	    };
	    PurchaseInvoiceEditComponent.prototype.ngAfterViewInit = function () {
	        $.ajax({
	    ...
	    PurchaseInvoiceEditComponent.prototype.notify = function () {
	    };
	    PurchaseInvoiceEditComponent.prototype.update = function (entry) {
	        this.repository.saveEntryv1(entry);
	    };
	    PurchaseInvoiceEditComponent.prototype.delete = function (entry) {
	        this.repository.deleteEntry(entry);
	    };
	    PurchaseInvoiceEditComponent = __decorate([
	        core_1.Component({
	        ...
	        __metadata("design:paramtypes", [router_1.Router, PurchaseInvoice_service_1.PurchaseInvoiceService, router_1.ActivatedRoute])
	    ], PurchaseInvoiceEditComponent);
	    return PurchaseInvoiceEditComponent;
	}());
	exports.PurchaseInvoiceEditComponent = PurchaseInvoiceEditComponent;
