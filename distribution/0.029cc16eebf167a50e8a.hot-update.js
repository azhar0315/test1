...
/***/ function(module, exports, __webpack_require__) {
	...
	var PurchaseInvoice_service_1 = __webpack_require__(454);
	var NewPurchaseInvoiceReadComponent = /** @class */ (function () {
	    function NewPurchaseInvoiceReadComponent(repository) {
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.math = function (i) {
	        // console.log(i)
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.select = function (name, adress) {
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.selectinventory = function (name, des, unit, i) {
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.findItem = function (value) {
	        var _this = this;
	        console.log(value);
	        if (value.length > 0) {
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.find = function () {
	        var _this = this;
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.show = function () {
	        document.getElementById('res').style.display = 'block';
	    };
	    NewPurchaseInvoiceReadComponent.prototype.hiden = function () {
	        document.getElementById('res').style.display = 'none';
	    };
	    NewPurchaseInvoiceReadComponent.prototype.showinven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'block';
	    };
	    NewPurchaseInvoiceReadComponent.prototype.hideninven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'none';
	    };
	    NewPurchaseInvoiceReadComponent.prototype.findTotal = function () {
	        setTimeout(function () {
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.removeItem = function (i) {
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.ngOnInit = function () {
	        var _this = this;
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.save = function (entry) {
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.ngOnDestroy = function () {
	        this.repository.unregisterObserver(this);
	    };
	    NewPurchaseInvoiceReadComponent.prototype.ngAfterViewInit = function () {
	        $.ajax({
	    ...
	    NewPurchaseInvoiceReadComponent.prototype.notify = function () { };
	    NewPurchaseInvoiceReadComponent = __decorate([
	        core_1.Component({
	    ...
	    return NewPurchaseInvoiceReadComponent;
	}());
	exports.NewPurchaseInvoiceReadComponent = NewPurchaseInvoiceReadComponent;
