...
/***/ function(module, exports, __webpack_require__) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	var core_1 = __webpack_require__(3);
	var SalesInvoice_interface_1 = __webpack_require__(507);
	var SalesInvoice_service_1 = __webpack_require__(508);
	var router_1 = __webpack_require__(304);
	var SalesInvoiceEditComponent = /** @class */ (function () {
	    function SalesInvoiceEditComponent(router, repository, activatedRoute) {
	        this.router = router;
	        this.repository = repository;
	        this.activatedRoute = activatedRoute;
	        this.entry = new SalesInvoice_interface_1.SalesInvoiceInterface();
	        this.customer = [];
	        this.inventory = [];
	    }
	    SalesInvoiceEditComponent.prototype.math = function (i) {
	    ...
	    SalesInvoiceEditComponent.prototype.findTotal = function () {
	    ...
	    SalesInvoiceEditComponent.prototype.findItem = function (value) {
	        var _this = this;
	        console.log(value);
	        if (value.length > 0) {
	    ...
	    SalesInvoiceEditComponent.prototype.selectinventory = function (name, des, unit, i) {
	    ...
	    SalesInvoiceEditComponent.prototype.showinven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'block';
	    };
	    SalesInvoiceEditComponent.prototype.hideninven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'none';
	    };
	    SalesInvoiceEditComponent.prototype.show = function () {
	        document.getElementById('res').style.display = 'block';
	    };
	    SalesInvoiceEditComponent.prototype.hiden = function () {
	        document.getElementById('res').style.display = 'none';
	    };
	    SalesInvoiceEditComponent.prototype.select = function (name, adress) {
	    ...
	    SalesInvoiceEditComponent.prototype.find = function () {
	        var _this = this;
	        ...
	        if (this.entry.customer.length > 0) {
	            this.repository.searchCustomer(this.entry.customer)
	                ...
	                .then(function (customer) { return console.log(_this.customer); });
	        }
	        if (this.entry.customer.length == 0) {
	    ...
	    SalesInvoiceEditComponent.prototype.add = function (entry) {
	        this.entry.items.push(new SalesInvoice_interface_1.items());
	    };
	    SalesInvoiceEditComponent.prototype.removeItem = function (i) {
	    ...
	    SalesInvoiceEditComponent.prototype.ngOnInit = function () {
	        var _this = this;
	    ...
	    SalesInvoiceEditComponent.prototype.ngOnDestroy = function () {
	        this.repository.unregisterObserver(this);
	    };
	    SalesInvoiceEditComponent.prototype.notify = function () {
	    };
	    SalesInvoiceEditComponent.prototype.update = function (entry) {
	        this.repository.saveEntryv1(entry);
	    };
	    SalesInvoiceEditComponent.prototype.ngAfterViewInit = function () {
	        $.ajax({
	    ...
	    SalesInvoiceEditComponent.prototype.delete = function (entry) {
	        this.repository.deleteEntry(entry);
	    };
	    SalesInvoiceEditComponent = __decorate([
	        core_1.Component({
	            selector: 'NewSalesInvoiceEdit',
	            template: __webpack_require__(511),
	        }),
	        __metadata("design:paramtypes", [router_1.Router, SalesInvoice_service_1.SalesInvoiceService, router_1.ActivatedRoute])
	    ], SalesInvoiceEditComponent);
	    return SalesInvoiceEditComponent;
	}());
	exports.SalesInvoiceEditComponent = SalesInvoiceEditComponent;
