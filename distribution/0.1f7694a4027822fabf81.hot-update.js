...
/***/ function(module, exports, __webpack_require__) {
	...
	var SalesInvoice_service_1 = __webpack_require__(508);
	var NewSalesInvoiceReadComponent = /** @class */ (function () {
	    function NewSalesInvoiceReadComponent(repository) {
	    ...
	    NewSalesInvoiceReadComponent.prototype.aa = function (i) {
	        console.log("pushed ..!");
	        console.log(i);
	        // this.test[i]={
	        //         itemname: null,
	    ...
	    NewSalesInvoiceReadComponent.prototype.math = function (i) {
	        // console.log(i)
	    ...
	    NewSalesInvoiceReadComponent.prototype.select = function (name, adress) {
	    ...
	    NewSalesInvoiceReadComponent.prototype.selectinventory = function (name, des, unit, i) {
	        ...
	        document.getElementById(i + 'amount').value = unit;
	    };
	    NewSalesInvoiceReadComponent.prototype.findItem = function (value) {
	        var _this = this;
	        console.log(value);
	        if (value.length > 0) {
	    ...
	    NewSalesInvoiceReadComponent.prototype.find = function () {
	        var _this = this;
	    ...
	    NewSalesInvoiceReadComponent.prototype.show = function () {
	        document.getElementById('res').style.display = 'block';
	    };
	    NewSalesInvoiceReadComponent.prototype.hiden = function () {
	        document.getElementById('res').style.display = 'none';
	    };
	    NewSalesInvoiceReadComponent.prototype.showinven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'block';
	    };
	    NewSalesInvoiceReadComponent.prototype.hideninven = function (i) {
	        document.getElementById(i + 'inven').style.display = 'none';
	    };
	    NewSalesInvoiceReadComponent.prototype.findTotal = function () {
	    ...
	    NewSalesInvoiceReadComponent.prototype.add = function (value) {
	    ...
	    NewSalesInvoiceReadComponent.prototype.removeItem = function (i) {
	    ...
	    NewSalesInvoiceReadComponent.prototype.ngOnInit = function () {
	        var _this = this;
	    ...
	    NewSalesInvoiceReadComponent.prototype.save = function (entry) {
	    ...
	    NewSalesInvoiceReadComponent.prototype.ngOnDestroy = function () {
	        this.repository.unregisterObserver(this);
	    };
	    NewSalesInvoiceReadComponent.prototype.ngAfterViewInit = function () {
	        $.ajax({
	    ...
	    NewSalesInvoiceReadComponent.prototype.notify = function () { };
	    NewSalesInvoiceReadComponent = __decorate([
	        core_1.Component({
	        ...
	        __metadata("design:paramtypes", [SalesInvoice_service_1.SalesInvoiceService])
	    ], NewSalesInvoiceReadComponent);
	    return NewSalesInvoiceReadComponent;
	}());
	exports.NewSalesInvoiceReadComponent = NewSalesInvoiceReadComponent;
