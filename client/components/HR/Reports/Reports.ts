...
import { HRReportsService } from './Service/Reports.service';
...
export class HRReportsReadComponent implements OnInit, OnDestroy, ReportsObserver {
    ...
    constructor(private repository: HRReportsService) {
