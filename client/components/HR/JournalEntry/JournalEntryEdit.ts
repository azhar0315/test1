...
@Component({
    selector: 'NewJournalEntryEdit',
    template: require('./JournalEntryEdit.html'),

})
export class HRJournalEntryEditComponent implements OnInit, OnDestroy, JournalEntryObserver {
    ...
    iname;
    ides;
    constructor(private router: Router, private repository: HRJournalEntryService, private activatedRoute: ActivatedRoute) {
