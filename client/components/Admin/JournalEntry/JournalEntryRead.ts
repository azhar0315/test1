...
export class AdminJournalEntryviewComponent implements OnInit {
    entry: JournalEntryInterface = new JournalEntryInterface();

    constructor(private router: Router, private activatedRoute: ActivatedRoute, private repository: AdminJournalEntryService) {
    }
