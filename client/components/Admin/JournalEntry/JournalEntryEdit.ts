...
export class AdminJournalEntryEditComponent implements OnInit, OnDestroy, JournalEntryObserver {
    ...
    iname;
    ides;
    constructor(private router: Router, private repository: AdminJournalEntryService, private activatedRoute: ActivatedRoute) {
