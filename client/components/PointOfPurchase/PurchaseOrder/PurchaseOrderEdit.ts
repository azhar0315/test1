...
@Component({
    ...
    template: require('./PurchaseOrderEdit.html'),
    styles: [`
    input.ng-dirty.ng-invalid { border: solid red 2px; }
    input.ng-dirty.ng-valid { border: solid green 2px; }`]

})
export class PurchaseOrderEditComponent implements OnInit, OnDestroy, PurchaseOrderObserver {
    ...
    constructor(private router: Router, private repository: PurchaseOrderService, private activatedRoute: ActivatedRoute) {
