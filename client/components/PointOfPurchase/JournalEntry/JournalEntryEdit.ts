...
export class POPJournalEntryEditComponent implements OnInit, OnDestroy, JournalEntryObserver {
    ...
    iname;
    ides;
    constructor(private router: Router, private repository: POPJournalEntryService, private activatedRoute: ActivatedRoute) {
