...
import { POPSummaryService } from './Service/Summary.service';
...
export class POPSummaryReadComponent implements OnInit, OnDestroy, SummaryObserver {
    ...
    constructor(private repository: POPSummaryService) {
