...
import { SalesQuoteInterface, items } from './Service/SalesQuote.interface';
...
@Component({
    selector: 'NewSalesQuoteEdit',
    template: require('./SalesQuoteEdit.html'),

})
export class SalesQuoteEditComponent implements OnInit, OnDestroy, SalesQuoteObserver {
    ...
    iname;
    ides;
    constructor(private router: Router, private repository: SalesQuoteService, private activatedRoute: ActivatedRoute) {
