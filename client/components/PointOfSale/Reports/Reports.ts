...
import { PointOfSaleReportsService } from './Service/Reports.service';
...
export class PointOfSaleReportsReadComponent implements OnInit, OnDestroy, ReportsObserver {
    ...
    constructor(private repository: PointOfSaleReportsService) {
