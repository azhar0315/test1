...
export class POSJournalEntryEditComponent implements OnInit, OnDestroy, JournalEntryObserver {
    ...
    iname;
    ides;
    constructor(private router: Router, private repository: POSJournalEntryService, private activatedRoute: ActivatedRoute) {
