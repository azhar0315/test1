...
import { POSJournalEntryService } from './Service/JournalEntry.service';
...
export class POSJournalEntryReadComponent implements OnInit, OnDestroy, JournalEntryObserver {
    ...
    constructor(private repository: POSJournalEntryService) {
