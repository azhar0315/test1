...
import { POSSummaryService } from './Service/Summary.service';
...
export class POSSummaryReadComponent implements OnInit, OnDestroy, SummaryObserver {
    ...
    constructor(private repository: POSSummaryService) {
